...
public class HttpUtilsVideo {
    private APIServiceVideo apiService;
    ...
    private HttpUtilsVideo(){
        ...
        OkHttpClient client = new OkHttpClient().newBuilder()
                .readTimeout(APIServiceVideo.timeOut, TimeUnit.SECONDS)
                .connectTimeout(APIServiceVideo.timeOut,TimeUnit.SECONDS)
...
//                .addConverterFactory(GsonConverterFactory.create(gson))
                ...
                .baseUrl(APIServiceVideo.HOST_APP)
                .build();
        apiService = retrofit.create(APIServiceVideo.class);
    }
    //创建单利模式
    private static class SingleHolder{
        private static final HttpUtilsVideo UTILS = new HttpUtilsVideo();
    }
    //获取实例
    public static APIServiceVideo getInstance(){
