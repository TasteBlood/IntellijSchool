...
import com.cloudcreativity.intellijSchool.databinding.LayoutCommonDialogBinding;
...
public class CommonDialogUtils {
    ...
    public void show(BaseDialogImpl baseDialog ,Context context,int pid,int fromId,int toId,OnSuccessListener successListener){
        ...
        LayoutCommonDialogBinding binding = DataBindingUtil.inflate(LayoutInflater.from(context),R.layout.layout_common_dialog,null,false);
