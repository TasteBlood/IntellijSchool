...
public abstract class DefaultObserverVideo<T> implements Observer<T> {
    private BaseDialogImpl impl;
    protected DefaultObserverVideo(BaseDialogImpl impl){
        this.impl = impl;
    }
    protected DefaultObserverVideo(BaseDialogImpl impl , boolean isShowProgress){
        this.impl = impl;
        if(isShowProgress)
